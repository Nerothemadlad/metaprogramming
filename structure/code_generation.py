...
class Sized(Descriptor):
    ...
    def set_code():
        ...
        return [
            ...
            "    raise ValueError(f'{value} exceeds max length {self.maxlen} for {self.name}')",
        ]
...
class Regex(Descriptor):
    ...
    def set_code():
        ...
        return [
            ...
            "    raise ValueError(f'{value} does not match the pattern for {self.name}')",
        ]
...
class Structure(metaclass=StructMeta):
    """A base class for other structure classes to inherit from"""
...
stock.ticker = "AAPL"
stock.name = "Apple"
print(stock.ticker, stock.name, stock.shares, stock.price)
start = time()
